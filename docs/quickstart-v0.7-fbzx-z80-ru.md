...
ROM-файлы и игры не включены в архив по юридическим причинам. В физических тестах использовались отдельно полученные пользователем копии; проект их не распространяет. Для повторения эксперимента используйте собственные законно полученные ROM-образы и snapshots/игры.
