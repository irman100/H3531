...
ROM-файлы и игры не включены в архив. В физических тестах автор использовал отдельно полученные копии ROM-образов, найденные на сайте Speccy4Ever, а тестовые `.z80` snapshots — материалы с Emu-Land. Эти файлы проект не зеркалирует и не распространяет; перед загрузкой или использованием сторонних ROM/игр необходимо самостоятельно проверить их лицензионный статус и применимые правила.
