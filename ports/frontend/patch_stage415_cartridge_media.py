...
if len(sys.argv) != 3:
    raise SystemExit('usage: patch_stage415_cartridge_media.py INPUT OUTPUT')
...
replacements = {
    'static const int STAGE42_SMALL_W = 164;': 'static const int STAGE42_SMALL_W = 190;',
    'static const int STAGE42_SMALL_H = 266;': 'static const int STAGE42_SMALL_H = 250;',
    'static const int STAGE42_SELECTED_W = 224;': 'static const int STAGE42_SELECTED_W = 238;',
    'static const int STAGE42_SELECTED_H = 294;': 'static const int STAGE42_SELECTED_H = 286;',
}
for old, new in replacements.items():
    if old not in src:
        raise SystemExit(f'geometry constant missing: {old}')
