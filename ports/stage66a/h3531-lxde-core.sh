...
XFBDEV_SHADOW_LIVE="$BASE/bin/Xfbdev-shadow-live"
if [ "${H3531_X11_FULLFRAME_FB:-0}" = "1" ] && [ -x "$XFBDEV_SHADOW_LIVE" ]; then
    XFBDEV="$XFBDEV_SHADOW_LIVE"
    XFBDEV_MODE=shadow-live
elif [ "${H3531_X11_FULLFRAME_FB:-0}" = "1" ]; then
